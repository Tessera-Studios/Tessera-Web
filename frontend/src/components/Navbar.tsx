...
function Navbar() {
  ...
  return (
    <>
      ...
      {/* Sliding Sidebar */}
      <div
        className={`lg:hidden fixed top-0 left-0 w-[65vw] h-[100vh] bg-[linear-gradient(180deg,var(--background),var(--dark-purple))] text-white flex flex-col items-center py-6 pt-30 gap-5 z-40 transform transition-transform duration-300 ease-in-out ${
