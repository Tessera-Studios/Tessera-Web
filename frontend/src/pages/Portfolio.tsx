...
function Portfolio() {
    ...
    return <div className="portfolio-page w-full min-h-[100vh] pt-16 md:pt-28 pb-8 md:pb-20 px-0 text-white flex flex-col items-stretch gap-8">
        <header className="w-full px-6 md:px-16">
            <h1 className="mb-6 text-center text-5xl md:text-6xl font-bold tracking-tight">Our Portfolio</h1>
